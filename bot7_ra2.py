...
def trendadjust( curasset, change ):
   ...
   if curasset.middle1w < curasset.lastprice:
      if curasset.levdefault < 1.120:
         curasset.levdefault = 1.120
         curasset.levmax = 1.1500     
   else:
      if curasset.levdefault < 1.1300:
         curasset.levdefault = 1.1300
         curasset.levmax = 1.1600     
