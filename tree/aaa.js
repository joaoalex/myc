		  ...
		  if (childparent == data2['outwardIssue']['key'] ) {
		    ...
		    if (data[j]['inwardIssue']['fields']['issuetype']['name'] == 'Epic')
				...
				for (let v=0; v<keys3.length;v++){ 
				    //console.log('--- issue XXX --- ' + data3['issues'][z]['key'] + ' ' + data3['issues'][z]['self']);
						...
						arr.push({name: data3['issues'][v]['fields']['summary'].slice(0, 100), text: data3['issues'][v]['fields']['summary'].slice(0, 100), data: { status: data3['issues'][v]['fields']['status']['name'] , priority: data3['issues'][v]['fields']['priority']['name'],  key: "3.2 " + data3['issues'][v]['key']},a_attr: {  href: "https://jira.k8s2.grupocgd.com/browse/" + data3['issues'][v]['key'] }, icon: data3['issues'][v]['fields']['issuetype']['iconUrl']  } );
							
							
					    }
                        //console.log(arr)						
						arrchild3.push({text: data[j]['inwardIssue']['fields']['summary'].slice(0, 100),children: arr, data: { status: data[j]['inwardIssue']['fields']['status']['name'] , priority: data[j]['inwardIssue']['fields']['priority']['name'],  key: "3.2 " + data[j]['inwardIssue']['key']},a_attr: {  href: "https://jira.k8s2.grupocgd.com/browse/" + data[j]['inwardIssue']['key'] }, icon: data[j]['inwardIssue']['fields']['issuetype']['iconUrl']  } );			
			...
			for (let z=0; z < keys4.length;z++){ 
				...
				}catch
				{
					...
					if (data4['fields']['issuelinks'][z]['inwardIssue']['fields']['issuetype']['name'] == 'Epic')
					{
						...
						// ----------------------------------------------------- issueslinks nivel 2    
							...
							for (let v=0; v < keys5.length;v++){ 
								...
								//console.log('---' + v + '---');
								//console.log(data5['fields']['issuelinks'][0]);
								...
								try{
									...
									arrchild3.push({text: data5['fields']['issuelinks'][v]['inwardIssue']['fields']['summary'].slice(0, 100), data: { status: data5['fields']['issuelinks'][v]['inwardIssue']['fields']['status']['name'] , priority: data5['fields']['issuelinks'][v]['inwardIssue']['fields']['priority']['name'],  key: "3.2 " }, a_attr: {  href: "https://jira.k8s2.grupocgd.com/browse/" + data5['fields']['issuelinks'][v]['inwardIssue']['key'] }, icon: data5['fields']['issuelinks'][v]['inwardIssue']['fields']['issuetype']['iconUrl']  } );
					...
					{
							arrchild3.push({text: data4['fields']['issuelinks'][z]['inwardIssue']['fields']['summary'].slice(0, 100), data: { status: data4['fields']['issuelinks'][z]['inwardIssue']['fields']['status']['name'] , priority: data4['fields']['issuelinks'][z]['inwardIssue']['fields']['priority']['name'],  key: "3.2 " + data4['fields']['issuelinks'][z]['inwardIssue']['key']},a_attr: {  href: "https://jira.k8s2.grupocgd.com/browse/" + data4['fields']['issuelinks'][z]['inwardIssue']['key'] }, icon: data4['fields']['issuelinks'][z]['inwardIssue']['fields']['issuetype']['iconUrl']  } );
					}					
...
async function get_request(project){
  ...
  for (let i=0; i<keys.length;i++)
  {
      ...
      //console.log('-------------- ' +  data['issues'][i]['key'] + ' ' + data['issues'][i]['fields']['summary'] + ' --------------')
	  arrchild = await child( data['issues'][i]['key'], data['issues'][i]['fields']['issuelinks'])
	  
	  //console.log(arrchild);
	  //console.log('-------------')
	
	  //arr.push({id: i, key: data['issues'][i]['key'], name: data['issues'][i]['fields']['summary'].slice(0, 100), text: data['issues'][i]['fields']['summary'].slice(0, 100), parent_id: "0", children: arrchild, data:  { status: data['issues'][i]['fields']['status']['name'], key: "1 " +  data['issues'][i]['key'] }, a_attr: {  href: "https://jira.k8s2.grupocgd.com/browse/" + data['issues'][i]['key'] },  icon: data['issues'][i]['fields']['issuetype']['iconUrl'] } )
...
async function start() {
		...
		var data = await get_request("TME");
		console.log('=============================');
		console.log(data );
